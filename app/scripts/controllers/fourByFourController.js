 ...
 */
angular.module('gameApp').controller('FourByFourCtrl', function() {
	var vm = this;
	//var Helpers = require('./util.js');
	vm.tiles_4x4 = Helpers.Funcs.memory_tile_shuffle(Helpers.Boards.tiles_4x4);
	vm.tilesCount = vm.tiles_4x4.length;
	vm.totalClicks = 0;
	vm.tiles_flipped = 0;
	vm.flipped = false;
	vm.matched_values = [];
	...
	vm.memory_tile_shuffle = function() {
		vm.closeTiles();
		Helpers.Funcs.memory_tile_shuffle(vm.tiles_4x4);
	};
