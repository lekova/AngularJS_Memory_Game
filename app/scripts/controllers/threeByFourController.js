...
angular.module('gameApp').controller('ThreeByFourCtrl', function() {

	var vm = this;
	//var Helpers = require('./util.js');
	vm.tiles_3x4 = Helpers.Funcs.memory_tile_shuffle(Helpers.Boards.tiles_3x4);
	...
	vm.memory_tile_shuffle = function() {
		vm.closeTiles();
		Helpers.Funcs.memory_tile_shuffle(vm.tiles_3x4);
	};
